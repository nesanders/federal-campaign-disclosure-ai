    ...
    dashboard = {
        "meta": {
            ...
            "recommended_additional_sources": [
                "Matt Lockshin's Progressive Job Board (mattlockshin.com/job-board) -- a specialized progressive digital-roles board, found via Social Justice Leadership's resource page but not yet fetched (its www subdomain needs its own access, separate from the bare domain).",
